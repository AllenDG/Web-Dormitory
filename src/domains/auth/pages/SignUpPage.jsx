...
/**
 * Sign Up Page v3.0 - Split Screen Design
 * 
 * Features:
 * - Split screen layout (onboarding left, form right)
 * - Google Sign Up prominent
 * - Email registration secondary option
  ...
  return (
    <Box minH="100vh" display="flex">
      ...
      <Box
        ...
        overflowY="auto"
      >
        <VStack spacing={8} w="full" maxW="400px" py={8}>
          {/* Header */}
          <VStack spacing={3} w="full">
            ...
            <Text fontSize="md" color="gray.600" textAlign="center">
              To keep connected with us please register with your personal information
            </Text>
          </VStack>
          ...
          {!showEmailForm ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ width: '100%' }}>
              <VStack spacing={4} w="full">
                ...
                <Text fontSize="xs" color="gray.600" w="full" textAlign="center">
          ...
          <Box textAlign="center">
            <Text fontSize="sm" color="gray.500">
              {isOwnerSignup ? 'Looking for a place?' : 'Want to list your property?'}{' '}
              <Link to={isOwnerSignup ? "/signup" : "/owner/signup"}>
                <Text
                  as="span"
                  color="primary.600"
                  fontWeight="700"
                  _hover={{ textDecoration: 'underline' }}
                >
                  {isOwnerSignup ? 'Sign up as tenant' : 'Sign up as owner'}
                </Text>
              </Link>
            </Text>
          </Box>
